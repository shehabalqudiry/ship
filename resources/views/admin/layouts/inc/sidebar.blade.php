...
<div class="sidebar-wrapper">
    <div>
        <div class="logo-wrapper">
            <a href="">
                <img class="img-fluid for-light" width="50" src="{{ secure_asset(App\Models\Setting::first()->website_logo ?? 'assets/images/logo/logo.png') }}" alt="">
                <img class="img-fluid for-dark" width="50" src="{{ secure_asset(App\Models\Setting::first()->website_logo ?? 'assets/images/logo/logo_dark.png') }}"
                    alt="">
            </a>
        ...
        <div class="logo-icon-wrapper"><a href="{{ route('admin.dashboard') }}">
            <img class="img-fluid" width="50"
                    src="{{ secure_asset(App\Models\Setting::first()->website_logo ?? 'assets/images/logo/logo.png') }}"
                    alt=""></a></div>
